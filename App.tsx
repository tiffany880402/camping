...
const BottomNav = () => {
  ...
  const tabs = [
    { id: 'record', icon: Home, label: '紀錄', path: '/' },
...
const RecordPage = ({ trips, onAddTrip, onDeleteTrip }: { trips: CampingTrip[], onAddTrip: (trip: CampingTrip) => void, onDeleteTrip: (id: string) => void }) => {
  const navigate = useNavigate();
  ...
  return (
    <BrowserRouter>
      <div className="max-w-md mx-auto min-h-screen relative selection:bg-morandi-100 selection:text-morandi-900 border-x border-stone-200/20 shadow-2xl bg-white">
        ...
        <AnimatePresence mode="wait">
          <Routes>
            <Route path="/" element={<RecordPage trips={trips} onAddTrip={handleAddTrip} onDeleteTrip={handleDeleteTrip} />} />
